...
<head>
    ...
    <title>Bukti Pinjam Part #{{ str_pad($header->id, 5, '0', STR_PAD_LEFT) }}</title>
    <style>
    ...
    <div class="page">
        ...
        <div class="kop">
            <div class="kop-left">
                ...
                <div class="company-sub">{{ $header->nama_rayon }}</div>
            </div>
            <div class="kop-right">
        ...
        <table class="info-table">
            ...
            <tr>
                <td>Nama Teknisi</td>
                <td>:</td>
                <td>{{ $header->nama_technician }}</td>
            </tr>
            <tr>
                <td>Jumlah Item</td>
                <td>:</td>
                <td>{{ $items->count() }} jenis sparepart</td>
            </tr>
        ...
        <table class="items">
            <thead>
                <tr>
                    ...
                    <th class="center" style="width:40px;">Jml</th>
                    <th class="center" style="width:75px;">Total Tas Teknisi</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($items as $i => $item)
                    <tr>
                        <td>{{ $i + 1 }}.</td>
                        <td>
                            <div>{{ $item->nama_sparepart }}</div>
                            <div class="part-code">{{ $item->code_part ?? '-' }}</div>
                        </td>
                        <td class="center" style="font-weight:700;">{{ $item->jumlah }}</td>
                        <td class="center" style="font-weight:700;">{{ $saldoTeknisi[$item->sparepart_id] ?? 0 }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="total-baris">
            <table>
                <tr>
                    ...
                    <td class="total-val">{{ $items->sum('jumlah') }} pcs</td>
                </tr>
            </table>
        </div>
        ...
        <div class="ttd-section">
            ...
            <div class="ttd-box">
                ...
                <div class="ttd-line">( {{ $header->nama_technician }} )</div>
            </div>
        </div>
