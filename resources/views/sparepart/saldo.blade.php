    ...
    <div class="page">
        ...
        <div class="kop">
            <div class="kop-head">
                ...
                <div class="kop-meta">
                    ...
                    <strong>{{ $tanggalCetak }} WIB</strong>
                    <div style="margin-top:4px;">Total Item Terdaftar</div>
                    <strong>{{ $summary['total_item'] }} Part</strong>
                </div>
            </div>
        ...
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    @forelse ($spareparts as $index => $part)
                        ...
                        <tr class="{{ $isEmpty ? 'row-empty' : '' }}">
                            ...
                            <td class="td-stok col-total">{{ number_format($part->total_saldo) }} <small>Pcs</small></td>
                        </tr>
                    @empty
                        <tr>
                ...
                <tfoot>
                    <tr>
                        <td colspan="4" class="tfoot-label">Grand Total &mdash; {{ $summary['total_item'] }} Part :</td>
                        ...
                        <td class="td-stok col-total">{{ number_format($summary['total_saldo']) }} <small>Pcs</small></td>
                    </tr>
                </tfoot>
            </table>
        </div>
