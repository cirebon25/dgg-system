...
<?php endif; ?>
                    ...
                    <div>
                        <p class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($form->judul); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($form->deskripsi): ?>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($form->deskripsi); ?></p>
                ...
                <div class="flex gap-2 mt-auto">
                    <a
                        href="<?php echo e(Storage::url($form->file_path)); ?>"
                        target="_blank"
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 mx-auto mb-3 opacity-30']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\dgg-system\resources\views/filament/pages/cetak-form.blade.php ENDPATH**/ ?>