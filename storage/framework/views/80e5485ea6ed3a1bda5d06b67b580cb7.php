...
<div class="outer">
    ...
    <div class="kepada-row">
        ...
        <div class="kepada-right"><?php echo e($tanggalStr); ?></div>
    </div>
                ...
                <td class="col-uraian">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->plat_nomor) || !empty($item->km_awal) || !empty($item->km_akhir)): ?>
                        <div class="vehicle-detail">
                            [<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->plat_nomor)): ?> Plat No: <?php echo e(strtoupper($item->plat_nomor)); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                             <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->km_awal)): ?> | KM Awal: <?php echo e(number_format($item->km_awal,0,',','.')); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                             <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->km_akhir)): ?> | KM Akhir: <?php echo e(number_format($item->km_akhir,0,',','.')); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>]
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </td>
                <td class="col-kode" style="text-align:center;"><?php echo e($item->kode_perkiraan ?? ''); ?></td>
                <td class="col-jumlah" style="text-align:right;"><?php echo e($item->jumlah ? number_format($item->jumlah,0,',','.') : ''); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < $emptyRows; $i++): ?>
            <tr class="row-empty">
    ...
    <div class="footer-row">
        ...
        <div class="footer-right">
            ...
            <div class="rp-row-total">
                ...
                <span class="rp-total-val"><?php echo e($total > 0 ? number_format($total,0,',','.') : '0'); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="ttd-row">
        <div class="ttd-cell">Dibuat Oleh,<div class="ttd-name">( <?php echo e($data->pembuat ?? 'RUDI'); ?> )</div></div>
        <div class="ttd-cell">Diketahui Oleh,<div class="ttd-name">( <?php echo e($data->pemeriksa ?? 'RIZEN'); ?> )</div></div>
        <div class="ttd-cell">Disetujui,<div class="ttd-name">( .................... )</div></div>
        <div class="ttd-cell">Penerima,<div class="ttd-name">( <?php echo e($data->penerima ?? 'RUDI'); ?> )</div></div>
    </div>
...
</html><?php /**PATH C:\laragon\www\dgg-system\resources\views/print/cash-mutation.blade.php ENDPATH**/ ?>