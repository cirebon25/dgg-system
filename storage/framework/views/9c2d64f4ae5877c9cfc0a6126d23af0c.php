...
<body onload="window.print()">
    <header>
        ...
        <p style="margin:0; font-size: 10px;">Periode:
            <?php echo e(Carbon\Carbon::create()->year($year)->month($month)->translatedFormat('F')); ?> <?php echo e($year); ?></p>
    </header>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rayons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rayon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="page-break">
            <div class="rayon-title">
                <span class="nama-rayon-kiri"> RAYON: <?php echo e($rayon->nama_rayon); ?></span>
            ...
            <table class="main-table">
                <thead>
                    ...
                    <tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 31; $i++): ?>
                            ...
                            ?>
                            <th width="18" class="<?php echo e($thWeekendClass); ?>"
                ...
                <tbody>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $deploymentsByKota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kota => $itemsInKota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td colspan="42" class="row-kota">
                                KOTA / KABUPATEN: <?php echo e($kota); ?>

                            </td>
                        </tr>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $itemsInKota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dep->customer && $dep->machine): ?>
                                <?php
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($m->tipe_model); ?></td>
                                    <td class="bold bg-seri"><?php echo e($m->serial_number); ?></td>
                                    <td>
                                        <?php echo e($dep->tanggal_instal ? \Carbon\Carbon::parse($dep->tanggal_instal)->format('d M Y') : '-'); ?>

                                    </td>

                                    
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($day = 1; $day <= 31; $day++): ?>
                                        <?php
                                        ...
                                        ?>
                                        <td class="<?php echo e($bgClass); ?>"
                                            style="font-size: 6.5px; font-weight: bold; white-space: nowrap; padding: 2px 0;">
                                            <?php echo e($logHariIni ? $logHariIni->tipe_kunjungan : ''); ?>
                                    ...
                                    <td class="bold" style="font-size: 7px; line-height: 1.3; padding: 2px 1px;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logs->isNotEmpty()): ?>
                                            <div><?php echo e($bwDisplay); ?></div>
                                            <div style="color: #cf1322; font-weight: bold; margin-top: 2px;">
                                                <?php echo e($colorDisplay); ?></div>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>

                                    <td><?php echo e($perbaikanDisplay); ?></td>
                                    <td><?php echo e($teknisi1Display); ?></td>
                                    <td><?php echo e($teknisi2Display); ?></td>
                                    <td class="bg-kontrak"><?php echo e($dep->no_kontrak ?? ($m->no_kontrak ?? '-')); ?></td>
                                    <td class="<?php echo e($classKeterangan); ?>"><?php echo e($textKeterangan); ?></td>
                                </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <table class="stat-table">
                ...
                <tbody>
                    <tr>
                        <td class="stat-rn"><?php echo e($stat['RN']); ?></td>
                        <td class="stat-rm"><?php echo e($stat['RM']); ?></td>
                        <td class="stat-cm"><?php echo e($stat['CM']); ?></td>
                        <td class="stat-rn"><?php echo e($stat['TN']); ?></td>
                        <td class="stat-rr"><?php echo e($stat['RR']); ?></td>
                        <td class="stat-blm"><?php echo e($stat['BELUM_RM']); ?></td>
                        <td class="stat-sudah"><?php echo e($stat['SUDAH_RM']); ?></td>
                        <td class="stat-total"><?php echo e($stat['TOTAL_MESIN']); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<?php /**PATH C:\laragon\www\dgg-system\resources\views/reports/rekap-horizontal.blade.php ENDPATH**/ ?>